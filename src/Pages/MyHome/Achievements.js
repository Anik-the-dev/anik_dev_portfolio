            ...
            <Container className=' ' >
                <Row className='align-items-center '>
                    ...
                    <Col sm className=''>
                        ...
                        <p className='text-center text-sm-start p-2 p-sm-0' style={{ color: '#000' }}>I have completed my graduation in CSE from a renowned engineering university of Bangladesh.In my student life, I helped some clients from Singapore and UK to build their websites and marketing their products.
                        </p>
